...
<x-slot name="title">Create New Currency</x-slot>
@section('content')
...
{!! Form::open(array('route' => 'mpcurs.store','method'=>'POST')) !!}
@csrf
<div class="h-64 grid grid-rows-4 grid-flow-col gap-4">
    ...
    <div>
        <div class="form-group">
            ...
            {!! Form::text('name', null, array('placeholder' => 'Currency Name','class' => 'form-control','required'=>true)) !!}
        </div>
    </div>
