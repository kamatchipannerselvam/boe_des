      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
          <div class="sidebar-brand-icon mx-4"><img class="img-fluid" src="{{ asset('image/logo.png') }}"/></div>
      </a>
      <!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInbound" class="collapse" aria-labelledby="headingInbound" data-parent="#accordionSidebar">
          <div class="bg-gray-500 py-2 collapse-inner rounded">
            ...
            <a class="collapse-item flex items-center text-Indigo-900 py-2 pl-4 nav-item" href="{{ route('boeinb.stepone') }}">Receive Inventory</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseOutbound" class="collapse" aria-labelledby="headingOutbound" data-parent="#accordionSidebar">
          <div class="bg-gray-500 py-2 collapse-inner rounded">
            <h6 class="collapse-header">Transactions:</h6>
            <a class="collapse-item flex items-center text-Indigo-900 py-2 pl-4 nav-item" href="{{ route('boeinb.index')}}">Available Stocks</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseItemmaster" class="collapse" aria-labelledby="headingItemmaster" data-parent="#accordionSidebar">
          <div class="bg-gray-500 py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('mproducts.index') }}">Manage Items</a>
            <a class="collapse-item" href="{{ route('mpcoos.index') }}">Manage COO</a>
            <a class="collapse-item" href="{{ route('mpcurs.index') }}">Manage Currency</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Customer Details:</h6>
            <a class="collapse-item" href="{{ route('mcustomers.index') }}">Manage Customers</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
