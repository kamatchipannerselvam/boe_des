        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <?php echo e(__('BOE Data Entry System')); ?>

                </div>
                <div class="flex-shrink-0 flex items-center">    
                <a href="index.html" class="flex items-center text-indigo-900 opacity-75 hover:opacity-100 py-4 pl-6">
                    <i class="fas fa-file-pdf mr-1 ml-0"></i>Document Submission 
                    <code class="rounded-full h-8 w-8 mt-1 ml-1 mb-1 flex items-center justify-center bg-warning">
                        10
                      </code>
                </a>
                </div>  
                <div class="flex-shrink-0 flex items-center">    
                <a href="index.html" class="flex items-center text-indigo-900 opacity-75 hover:opacity-100 py-4 pl-6">
                    <i class="fas fa-file-export mr-1 ml-0"></i>Pending POD's 
                    <code class="rounded-full h-8 w-8 mt-1 ml-1 mb-1 flex items-center justify-center bg-danger text-white">
                        10
                      </code>
                </a>
                </div>  
...
<?php /**PATH E:\xampp5\htdocs\boe_des\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>